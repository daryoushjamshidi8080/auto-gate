...
class TagPermission(models.Model):
    ...
    antenna = models.ManyToManyField(antennas, related_name="antenna_permissions")
...
class Tag(models.Model):
    ...
    rule = models.ForeignKey(TagPermission, on_delete=models.CASCADE, related_name="tags_permissions")
    is_active = models.BooleanField(default=True)
